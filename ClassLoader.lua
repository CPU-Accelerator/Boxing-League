-- This script was made by CPU_Accelerator and Roblaxin Pro. 
-- These boxing league scripts is open source so feel free to learn off of it

repeat task.wait() until game:IsLoaded()

setclipboard("https://discord.gg/PPFYacGb2b")
print("Join our server! https://discord.gg/PPFYacGb2b")
